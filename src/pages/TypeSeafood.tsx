    ...
    <IonPage>
      ...
      <IonContent fullscreen>    
        <IonList class="ion-no-padding ion-no-margin" color="dark">
          <h6 className="ion-padding bio typeh6-custom">Seafood</h6>
        </IonList>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  ...
                  <IonText color="dark"><h6 className="cardtitle3-custom">Stress-Free Scallops</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type2-EtiennePauthenet.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">So-Simple Black Cod</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            ...
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" /> 
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Salmon</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type2-EtiennePauthenet.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Crispy Trout</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type2-EtiennePauthenet.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Albacore Tuna Confit</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>

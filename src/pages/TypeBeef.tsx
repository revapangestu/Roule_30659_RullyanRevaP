    ...
    <IonPage>
      ...
      <IonContent fullscreen>    
        <IonList class="ion-no-padding ion-no-margin" color="dark">
          <h6 className="ion-padding bio typeh6-custom">Beef</h6>
        </IonList>
          ...
          <IonRow>
            ...
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Steak</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            ...
            <IonCol>
              <IonCard>
                <div>
                  ...
                  <IonText color="dark"><h6 className="cardtitle3-custom">Basic Burger</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Grilled Chuck Steak</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Center-Cut Tenderloin Roast</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>

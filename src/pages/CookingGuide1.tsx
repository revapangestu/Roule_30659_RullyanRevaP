    ...
    <IonPage>
      ...
      <IonContent fullscreen>    
        <IonList class="ion-no-padding ion-no-margin" color="dark">
          <h6 className="ion-padding bio typeh6-custom">Get Started: Basic Guides</h6>
        </IonList>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  ...
                  <IonText color="dark"><h6 className="cardtitle3-custom">Basic Salmon</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Burger</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  ...
                  <IonText color="dark"><h6 className="cardtitle3-custom">Basic Steak</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type2-EtiennePauthenet.jpg" /> 
                  <IonText color="dark"><h6 className="cardtitle3-custom">Basic Pork Chop</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Basic Chicken Breast</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Basic Chicken Thighs</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>

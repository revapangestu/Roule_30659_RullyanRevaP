    ...
    <IonPage>
      ...
      <IonContent fullscreen>    
        <IonList class="ion-no-padding ion-no-margin" color="dark">
          <h6 className="ion-padding bio typeh6-custom">Lamb</h6>
        </IonList>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  ...
                  <IonText color="dark"><h6 className="cardtitle3-custom">Braised and Glazed Lamb Shank</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">One Lovely Leg of Lamb</h6><br/></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  ...
                  <IonText color="dark"><h6 className="cardtitle3-custom">Tender Juicy Lamb Chops</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type2-EtiennePauthenet.jpg" /> 
                  <IonText color="dark"><h6 className="cardtitle3-custom">House style Lamb Chops</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Basic Lamb</h6><br/></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Lamb</h6><br/></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>

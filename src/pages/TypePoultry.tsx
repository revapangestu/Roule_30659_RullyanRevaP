    ...
    <IonPage>
      ...
      <IonContent fullscreen>    
        <IonList class="ion-no-padding ion-no-margin" color="dark">
          <h6 className="ion-padding bio typeh6-custom">Poultry</h6>
        </IonList>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  ...
                  <IonText color="dark"><h6 className="cardtitle3-custom">Basic Chicken Breast</h6><br/></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Chicken Breast</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  ...
                  <IonText color="dark"><h6 className="cardtitle3-custom">Ultimate Chicken Thighs</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type2-EtiennePauthenet.jpg" /> 
                  <IonText color="dark"><h6 className="cardtitle3-custom">Tender Turkey Breast</h6><br/></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
          ...
          <IonRow>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Confit Turkey Leg</h6><br/></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
            <IonCol>
              <IonCard>
                <div>
                  <img src="../../assets/image/Type1-AndresRodriguez.jpg" />
                  <IonText color="dark"><h6 className="cardtitle3-custom">Foolproof Fired Chciken</h6></IonText>
                  <br/>
                </div>
              </IonCard>
            </IonCol>
